...
public class MyBatisPlusAutoFillMetaInfoHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        this.strictInsertFill(metaObject, "createBy", () -> ((UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUsername(), String.class);
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        this.strictUpdateFill(metaObject, "updateBy", () -> ((UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUsername(), String.class);
